...
def async_setup_platform(hass, config, async_add_devices, discovery_info=None):
    ...
    async_add_devices([GenericHygrostat(
        hass, name, sensor_id, delta_trigger, target_offset, min_on_time, max_on_time, sample_interval, min_humidity, subsq_shower_detect)])
...
class GenericHygrostat(Entity):
    ...
    def __init__(self, hass, name, sensor_id, delta_trigger, target_offset,
                 min_on_time, max_on_time, sample_interval, min_humidity, subsq_shower_detect):
